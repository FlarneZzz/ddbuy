...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    ...
    <script type="text/javascript">
        function goPage(page){
            ...
            jq("#pageNum").val(page);
            //提交表单
            //document.getElementById("searchForm").submit();  //自动提交
...
<div class="top">
    ...
    <div class="search">
    	<form <%--onsubmit="goPage(1)"--%> action="Search" id="searchForm" name="searchForm" method="post">
        	<input type="text" value="${condition}" class="s_ipt" name="condition" />
            <!--保存页码-->
            <input type="text" id="pageNum" value="${pageNum}" class="s_ipt" name="pageNum" />
            <input type="button" value="搜索" class="s_btn" onclick="goPage(1)" />
        </form>                      
    ...
    <div class="content mar_20">
        ...
        <div class="l_list">
            ...
            <div class="list_c">
                ...
                <!--显示搜索的商品-->
                <ul class="cate_list">
                    <c:forEach items="${map.rows}" var="p">
                        <li>
                            <div class="img"><a target="_blank" href="http://localhost:81/${p.pid}.html"><img src="images/per_1.jpg" width="210" height="185" /></a></div>
                            <div class="price">
