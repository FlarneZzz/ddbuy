...
<div class="top">
    ...
    <div class="search">
    	<form action="http://localhost:8002/Search" method="get">
            <input txype="text" name="condition" class="s_ipt">
    	...
    	<div class="banner">    	
            <div class="top_slide_wrap">
                <ul class="slide_box bxslider">
                    <!--加载显示的广告-->
                    <c:forEach items="${allTbContent}" var="p">
                      <li><img src="${p.pic}" width="740" height="401" /></li>
                    </c:forEach>
                </ul>
