...
<DIV id=view class="main wrap">
    <DIV class=intro>
        <DIV class=lefter>
            <H1>${singleHouseByPrimaryKey.title}</H1>
            <DIV class=subinfo><fmt:formatDate value="${singleHouseByPrimaryKey.pubdate}" pattern="yyyy年MM月dd日"></fmt:formatDate></DIV>
            <DIV class=houseinfo>
                <P>户　　型：<SPAN>${singleHouseByPrimaryKey.tname}</SPAN></P>
                <P>面　　积：<SPAN>${singleHouseByPrimaryKey.floorage}m<SUP>2</SUP></SPAN></P>
                <P>位　　置：<SPAN>${singleHouseByPrimaryKey.dname}${singleHouseByPrimaryKey.sname}</SPAN></P>
                <P>联系方式：<SPAN>${singleHouseByPrimaryKey.contact}</SPAN></P></DIV></DIV>
        <div>
        ...
        <DIV class=introduction>
            ...
            <DIV class=content>
                <P>${singleHouseByPrimaryKey.description}</P></DIV></DIV></DIV></DIV>
